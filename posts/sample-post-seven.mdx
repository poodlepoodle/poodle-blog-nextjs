...
<img
  src="/blog/node-tooling/unix-poster.jpg"
  alt="Unix Magic poster, a wizard crafting a potion surrounded by ingredients named after Unix tools"
  height="500"
/>
...
Now I was ready to release the library! Or so I thought: for some reason, `.github/` was being included in the package contents. After some digging, I found I needed to add an `.npmignore`, something I've done in the past but forgot about. Thankfully, using it again caused me to remember that npm defaults to using your `.gitignore`, and when you add an npmignore it _no longer does!_ I copied the contents of my `.gitignore` over and added a line for `.github`.
