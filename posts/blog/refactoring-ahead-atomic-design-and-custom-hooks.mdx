...
> "(번역) 아토믹 디자인이 제공하는 큰 이점 중 하나는 추상적인 것과 구체적인 것 사이를 빠르게 전환할 수 있는 능력입니다." ― Brad Frost, 「Atomic Design Methodology」
...
- 참고: [Atomic Design Methodology (원문) | Brad Frost](https://atomicdesign.bradfrost.com/chapter-2/#the-part-and-the-whole)
...
위 방법처럼 스타일 요소를 별개의 파일로 분리한 후 named export해 사용함으로써
...
- 참고: [HTML Semantic Elements | W3Schools](https://www.w3schools.com/html/html5_semantic_elements.asp)
...
내비게이션 타이틀을 사용하는 페이지였기 때문에 `hoc/withNavigation`으로 감싸 주었고,
