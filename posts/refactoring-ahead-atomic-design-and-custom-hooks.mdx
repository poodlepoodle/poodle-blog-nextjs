...
![](/blog/posts/refactoring-ahead-atomic-design-and-custom-hooks/seasoning-thumbnail.webp?width=450)
...
![](/blog/posts/refactoring-ahead-atomic-design-and-custom-hooks/need-more-things.webp?width=320)
...
![](/blog/posts/refactoring-ahead-atomic-design-and-custom-hooks/content-editor-component-1.webp)
...
![](/blog/posts/refactoring-ahead-atomic-design-and-custom-hooks/content-editor-component-2.webp)
...
![](/blog/posts/refactoring-ahead-atomic-design-and-custom-hooks/atomic-design-brad-frost.webp?width=550)
...
![](/blog/posts/refactoring-ahead-atomic-design-and-custom-hooks/atom-example.webp?width=450)
...
![](/blog/posts/refactoring-ahead-atomic-design-and-custom-hooks/molecule-example.webp?width=670)
...
![](/blog/posts/refactoring-ahead-atomic-design-and-custom-hooks/differences-between-molecule-and-organism-example-1-tabbar.webp?width=700)
...
![](/blog/posts/refactoring-ahead-atomic-design-and-custom-hooks/differences-between-molecule-and-organism-example-2-feeditem.webp)
...
![](/blog/posts/refactoring-ahead-atomic-design-and-custom-hooks/differences-between-molecule-and-organism-example-3-menulist.webp)
...
![](/blog/posts/refactoring-ahead-atomic-design-and-custom-hooks/component-naming-example-carousel.webp)
...
![](/blog/posts/refactoring-ahead-atomic-design-and-custom-hooks/template-page-example.webp)
...
단, `HomePage`에서 `/home?category=year`처럼 Search Parameter에 따라 다르게 렌더링되는 영역이 존재하는 경우에는 template을 중첩해 표현했어요.

### 추가: HoC 패턴으로 공통 바깥 레이아웃을 분리

![](/blog/posts/refactoring-ahead-atomic-design-and-custom-hooks/template-using-hoc-pattern.webp)
...
![](/blog/posts/refactoring-ahead-atomic-design-and-custom-hooks/separation-of-concerns-example-hoc.webp?width=500)
...
![](/blog/posts/refactoring-ahead-atomic-design-and-custom-hooks/separation-of-concerns-example-custom-hooks.webp)
...
동시에 여러 상태를 포함하는 페이지일수록 많은 비즈니스 로직에 의존하며 context 파일의 코드가 길어지는 경향이 있었어요.
프로필 수정 페이지나 게시글 작성 및 수정 페이지처럼 폼 데이터를 활용하는 페이지가 가장 대표적인 예시였습니다.

![](/blog/posts/refactoring-ahead-atomic-design-and-custom-hooks/use-article-and-profile-form-custom-hook.webp?width=600)
...
앞서 작성한 `useProfileForm()`과 `useArticleForm()` 훅에서 이를 활용하도록 했습니다.
현재 입력된 이미지 배열을 가리키는 상태와 이미지 교체 및 삭제 등을 수행할 수 있는 핸들러 함수들을 선언해 인터페이스로 제공했어요.

![](/blog/posts/refactoring-ahead-atomic-design-and-custom-hooks/use-image-form-custom-hook.webp)
