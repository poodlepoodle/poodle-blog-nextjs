      ...
      <div className="flex w-full flex-col items-center">
        <div className="flex w-full max-w-container flex-col gap-[3.75rem] pt-container-top pb-container-bottom">
          <div className="flex w-fit flex-col gap-[1.5rem] px-[2.5rem] desktop:px-0">
            <div className="relative h-[3.5rem] w-[3.5rem] overflow-hidden rounded-full grayscale-100 transition-transform duration-250 ease-in-out hover:-translate-y-2">
              <ImageWithSkeleton
            ...
            <h1 className="text-lg font-semibold tracking-[-0.025rem] break-keep text-black transition-transform duration-250 ease-in-out hover:-translate-y-2">
