...
export const Banner = () => {
  ...
  return (
    ...
    >
      ...
      <div className="pointer-events-none absolute inset-0 z-overlay flex items-center justify-center px-[2.5rem]">
        <h1 className="text-center text-sm font-medium break-keep text-gray-3 transition-colors duration-300 group-hover:text-skyblue">
