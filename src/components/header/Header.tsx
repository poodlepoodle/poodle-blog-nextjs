...
export const Header = () => {
  ...
  if (isSpotlighted) return null;

  return (
    <header
      className={cn(
        'fixed top-0 z-header flex h-header w-full animate-fade-in-down items-center justify-center border-b-[0.5px] bg-[rgba(255,255,255,0.1)] backdrop-blur-[0.5rem] backdrop-saturate-200 transition-all duration-300',
