...
export const Chip = ({
  ...
  return (
    <div
      className={cn(
        'flex h-[1.75rem] min-w-fit cursor-pointer items-center justify-center gap-[0.75rem] rounded-full border-[0.5px] px-[0.8rem] whitespace-nowrap transition-all duration-250',
        isSelected
