...
export const PostImageModal = () => {
  ...
  return createPortal(
    <div
      className="fixed inset-0 z-1000 flex h-full w-full animate-fade-in cursor-pointer items-center justify-center bg-[rgba(0,0,0,0.7)] p-[2.5rem] backdrop-blur-sm tablet:p-[4rem] desktop:p-[5rem]"
    ...
    >
      ...
      <div className="relative flex h-full w-full animate-fade-in-up items-center">
