...
export const MDXContent = ({
  ...
  return (
    <article className="prose max-w-none gap-[3rem] px-[2rem] text-base leading-8 break-keep text-black tablet:prose-lg tablet:px-[2.5rem] tablet:leading-9 desktop:px-[5.5rem] prose-headings:font-bold prose-p:font-medium prose-li:font-medium [&_li::marker]:text-gray-2 [&>*]:py-0 [&>*:not(h2)]:my-post-paragraph [&>h2]:mt-post-h2 [&>h2]:mb-post-paragraph">
